const headerTemplate= (isLogin)=>{
    const SVG_LOGIN= `<svg width="30px" height="30px" viewBox="0 0 128 128" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
    ...
    const SVG_LOGOUT = `<svg width="30px" height="30px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" stroke="#B7BEE4" fill="none" stroke-width="2">
    <g id="SVGRepo_bgCarrier" stroke-width="0"/>
    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    const SVG_CART = `<svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#B7BEE4" stroke-width="1.5">
    <g id="SVGRepo_bgCarrier" stroke-width="0"/>
    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
    <g id="SVGRepo_iconCarrier">
    ...
    const SVG_HAMBUR= `<svg fill="#B7BEE4" width="40px" height="40px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"/>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
        <g id="SVGRepo_iconCarrier">
    ...
    header.innerHTML+=` ${SVGTemplate(SVG_HAMBUR)}
                        <h1 class="logo"><span class="flaming">Flaming</span><span class="games">Games</span></h1>
                        <ul class="navbar-list">
                            <li>${SVGTemplate(SVG_CART)}</li>
                            <li>${isLogin ? SVGTemplate(SVG_LOGIN) : SVGTemplate(SVG_LOGOUT)}</li>
                        </ul>` ;
